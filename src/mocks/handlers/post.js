...
export const getPostsMock = rest.get(
  `${BASE_URL}/post/all/1`,
  (req, res, ctx) => {
    const result = {
      message: 'All posts',
      posts: [postMockData, postMockData],
      totalPosts: 2,
    };
...
export const emptyPostsMock = rest.get(
  `${BASE_URL}/post/all/1`,
  (req, res, ctx) => {
...
export const getPostsWithImagesMock = rest.get(
  `${BASE_URL}/post/images/1`,
  (req, res, ctx) => {
    ...
    const result = {
      ...
      posts: [postWithImageOne],
    };
    return res(ctx.json(result));
  }
);

export const emptyPostsWithImagesMock = rest.get(
  `${BASE_URL}/post/images/1`,
  (req, res, ctx) => {

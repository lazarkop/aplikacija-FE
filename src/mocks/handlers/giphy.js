...
export const getTrendingGiphyMock = rest.get(
  `${GIPHY_URL}/trending`,
  (req, res, ctx) => {
    const result = {
      data: [
...
export const searchGiphyMock = rest.get(
  `${GIPHY_URL}/search`,
  (req, res, ctx) => {
    const result = {
      data: [
...
export const emptySearchGiphyMock = rest.get(
  `${GIPHY_URL}/search`,
  (req, res, ctx) => {
    const result = {
      data: [],
...
export const giphyHandlers = [
  getTrendingGiphyMock,
  searchGiphyMock,
  emptySearchGiphyMock,
];

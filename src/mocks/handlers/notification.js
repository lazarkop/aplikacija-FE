import { notificationData } from '../data/notification.mock';
import { BASE_ENDPOINT } from '../../services/axios';
import { rest } from 'msw';

const BASE_URL = `${BASE_ENDPOINT}/api/v1`;

export const emptyNotificationsMock = rest.get(
...
export const getUserNotificationsMock = rest.get(
  `${BASE_URL}/notifications`,
  (req, res, ctx) => {
    const result = {
...
export const markNotificationMock = rest.put(
